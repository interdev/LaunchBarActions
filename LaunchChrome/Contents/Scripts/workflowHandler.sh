...
###############################################################################
addResult() {
  RESULT="<item uid='$(xmlEncode "$1")' arg='$(xmlEncode "$2")' valid='$6' autocomplete='$7'><title>$(xmlEncode "$3")</title><subtitle>$(xmlEncode "$4")</subtitle><alwaysShowsSubtitle>true</alwaysShowsSubtitle><icon>$(xmlEncode "$5")</icon></item>"
  RESULTS+=("$RESULT")
}
